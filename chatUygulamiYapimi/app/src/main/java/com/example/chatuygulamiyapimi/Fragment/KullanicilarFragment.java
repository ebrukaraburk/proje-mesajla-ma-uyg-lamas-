package com.example.chatuygulamiyapimi.Fragment;
...
import com.example.chatuygulamiyapimi.Adapter.KullaniciAdapter;
                    ...
                    mQuery.addSnapshotListener(( new EventListener<QuerySnapshot>() {
                        ...
                        public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                            ...
                            if(value !=null){
                                ...
                                mAdapter=new KullaniciAdapter(mKullaniciList,v.getContext(),kullanici.getKullaniciId(),kullanici.getKullaniciProfil(),kullanici.getKullaniciIsmi());
